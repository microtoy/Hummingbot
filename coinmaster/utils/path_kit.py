...
def get_folder_path(*paths, auto_create=True, as_path_type=True) -> Union[str, Path]:
    """
...
def get_file_path(*paths, auto_create=True, as_path_type=True) -> Union[str, Path]:
    """
    获取相对于项目根目录的，文件的绝对路径
    :param paths: 文件路径
    :param auto_create: 是否自动创建
...
def get_backtest_folder_path(*paths, auto_create=True, as_path_type=True) -> Union[str, Path]:
    return get_folder_path(*paths, auto_create=auto_create, as_path_type=as_path_type)


def get_backtest_file_path(*paths, auto_create=True, as_path_type=True) -> Union[str, Path]:
    return get_file_path(*paths, auto_create=auto_create, as_path_type=as_path_type)
